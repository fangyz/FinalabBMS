$(function () {
    //获取试卷题目信息
    $.getJSON("/JoinUs/PaperManage/GetPaperQuestionList/" + $("#paper_id").val(),
        null, function (jsonObj) {
            if (jsonObj.Statu == "ok") {
                ...
                htmlStr += "<tr><td colspan='2'><a href='/JoinUs/PaperManage/Index/1'><button type='button' class='am-btn am-btn-primary'>确定</button></td></tr>";
                $("#tb_list tbody").empty();
