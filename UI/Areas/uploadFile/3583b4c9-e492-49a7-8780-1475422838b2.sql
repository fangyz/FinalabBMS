...
add constraint FK_TblUserMessage_ReceiveId 
foreign key(ReceiveId) references Tbl_MemberInformation(StuNum)

alter table Tbl_User_Message 
add constraint FK_TblUserMessage_SendId 
foreign key(SendId) references Tbl_MemberInformation(StuNum)
--创建系统消息表
--编号	Id	int
--发送Id	SendId	int
...
--创建成员信息表
create table Tbl_MemberInformation(
	StuNum	nvarchar(20) primary key not null,
	StuName	nvarchar(20) not null,
	Gender	nvarchar(1) not null default '男',
	QQNum	nvarchar(20) not null,
